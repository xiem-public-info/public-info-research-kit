...
def main() -> int:
    ...
    manifest = {
        ...
        "quality_contracts": [
            ...
            "gap_driven_public_web_and_contractor_evidence",
            "visible_input_confirmation_before_gui_submit",
            "conditional_social_query_stopping",
            "building_imagery_identity_and_use_boundaries",
