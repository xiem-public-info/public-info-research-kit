...
def main() -> int:
    ...
    manifest = {
        ...
        "base_release_tag": "v0.8.0-rc.6",
        "release_tag": None if args.candidate_revision else f"v{version}",
        "candidate_revision": args.candidate_revision or "2026-09-09-public-rc7-release",
        ...
        "private_source_commit": "81f7e19df51e0022c553be137607e766a249ab71",
        "private_revision_commit": args.private_revision_commit or "81f7e19df51e0022c553be137607e766a249ab71",
        ...
        "quality_contracts": [
            ...
            "frozen_request_contract_binding",
            "actual_execution_request_binding",
            "separate_continuation_authorization_binding",
