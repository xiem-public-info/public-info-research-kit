...
def main() -> int:
    ...
    manifest = {
        ...
        "base_release_tag": "v0.8.0-rc.4",
        "release_tag": None if args.candidate_revision else f"v{version}",
        "candidate_revision": args.candidate_revision or "2026-09-08-public-rc5-release",
        ...
        "private_source_commit": "9269953be2a2c319a5a53a7880209f6fdff7d4b5",
        "private_revision_commit": args.private_revision_commit or "1dc57aae935afc4ea11d833a0aff74c48ff1cfa2",
