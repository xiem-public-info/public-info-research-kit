# 公开信息研究工具包 0.8.0-rc.7 候选

本版补齐原生与住宅研究的实际执行请求检查、充分性回传绑定和旧回包只读兼容，保持住宅公开 rc.8 的接口不变。本目录为待发布 rc.7 候选；公开 main 与最新已发布标签仍为 v0.8.0-rc.6。
...
rc.7 候选保留此前渠道能力和原研究标准，新增实际执行检查与独立后续授权绑定。更新内容见 [本版说明](RELEASE_NOTES_0.8.0-rc.7.md)。发布后可复制 [安装提示词](INSTALL_PROMPT_0.8.0-rc.7.md)，首次安装见 [中文说明](RC_INSTALL_0.8.0.md)，已有安装见 [升级与回退](UPGRADE_0.8.0-rc.6_to_rc.7.md)。候选审查期间继续使用 [已发布 rc.6](https://github.com/xiem-public-info/public-info-research-kit/releases/tag/v0.8.0-rc.6)，旧标签和历史成果保留。
