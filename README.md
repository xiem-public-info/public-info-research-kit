...
这是一个通过公开 GitHub 仓库分发的 **个人多设备自助版** Codex Plugin。公开仓库只是为了便于本人控制的多个 Codex 账号和电脑下载、安装与更新；它不是商业服务，也不对外承诺公众支持。
...
0.5.0 将微信和小红书检索升级为 D-235 研究型搜索策略：先完成主体身份闭环，再按“主体—产品—客群—场景—摩擦—价值—阶段—比较”等语义原子组合并冻结精确检索词；查询提交后先判断内容供给，再决定继续阅读或换词。聚合页和 AI 摘要只能用于发现线索，关键结论仍需回到可见原文。

微信与小红书保留现有可见桌面研究能力：使用自己的正常账号和本机正常界面，保持合理频率，不绕过登录、验证码、付费墙、权限墙或风控；账号和平台后果由使用者自行承担。微信真实检索前，请本人登录微信并手动打开“搜一搜”页面、保持在前台；不把快捷键能否唤起搜一搜作为能力前提。同一台 Mac 上会争用鼠标、键盘、窗口焦点或剪贴板的任务应串行运行，这只是避免桌面冲突，不是授权机制。
