...
本版以 `v0.8.0-rc.3` 公开预发布，供其他电脑安装和验收；稳定 `main / v0.7.0` 保持不变。包含最新 D-291 空间坐标规则、D-292 研究编排、D-293 任务级授权和微信 AI 执行条件检查，不代表异机真实检索或用户验收已完成。[预发布下载](https://github.com/xiem-public-info/public-info-research-kit/releases/tag/v0.8.0-rc.3)；[中文安装说明](RC_INSTALL_0.8.0.md)。
