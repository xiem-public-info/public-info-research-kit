...
本版移植公开网页发现与缺口补证、上下游证据反馈、共享GUI提交前文字核对、社媒停止条件及建筑素材边界。实际执行绑定与住宅接口沿用rc.7；本版为rc.8预发布全量包，正式版rc.7和旧附件保留。
...
rc.8 保留此前渠道能力、原研究标准及实际执行／后续授权绑定，补齐近期可迁移方法。更新内容见 [本版说明](RELEASE_NOTES_0.8.0-rc.8.md)。发布后可复制 [安装提示词](INSTALL_PROMPT_0.8.0-rc.8.md)，首次安装见 [中文说明](RC_INSTALL_0.8.0.md)，已有安装见 [升级与回退](UPGRADE_0.8.0-rc.7_to_rc.8.md)。固定 rc.8 尚未公开时可使用 [rc.7正式版](https://github.com/xiem-public-info/public-info-research-kit/releases/tag/v0.8.0-rc.7)，旧标签和历史成果保留。
