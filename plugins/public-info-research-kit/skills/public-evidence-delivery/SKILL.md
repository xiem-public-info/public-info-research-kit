...
回传说明资料用途、实际对象及事件时点，分开新发现、旧线索补实、排错及未读正文。下游反馈采用变化，检索方仍按原请求判断充分性；见 [方法与回传分工](../../resources/public-web-research-method.v1.md)。建筑素材按 [图像用途与覆盖边界](../../resources/building-imagery-method.v1.md)分类，不把关系图或生成参考记成真实形态覆盖。
