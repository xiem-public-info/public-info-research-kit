...
按缺口选择资料、解释冲突及上下游回传，见 [公开网页方法](../../resources/public-web-research-method.v1.md)。任务涉及共享前台时，按 [共享GUI与输入核对](../../resources/shared-gui-input.v1.md)安排串行和检查点；不要求下游代定精确词或任务内配额。
